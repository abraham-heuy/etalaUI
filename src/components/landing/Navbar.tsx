...
const Navbar: React.FC = () => {
  ...
  // Main navigation items with dropdown content - UPDATED WITH CORRECT ROUTES
  const navItems: NavItem[] = [
    {
      name: "Marketplace",
      href: "/marketplace", // Changed from '#marketplace'
      icon: Store,
      dropdown: {
        sections: [
          {
            ...
            items: [
              ...
              },
              {
                name: "Household",
                icon: Home,
                href: "/marketplace/category/household",
                highlight: false,
              },
              {
                name: "Hardware",
                icon: Hammer,
                href: "/marketplace/category/hardware",
                highlight: false,
              },
              {
                name: "Pharmacy",
              ...
              },
              {
                name: "Baby & Kids",
                icon: Egg,
                href: "/marketplace/category/baby-kids",
                highlight: false,
              },
            ],
          },
            ...
            items: [
              {
                ...
                href: "/marketplace/store/s1",
                highlight: false,
              },
              {
                name: "Fashion House",
                href: "/marketplace/store/s2",
                highlight: false,
              },
              {
                name: "Home Essentials",
                href: "/marketplace/store/s8",
                highlight: false,
              },
              {
                name: "View All →",
    ...
    // In your Navbar.tsx, update the Farmers section:
            ...
            items: [
              {
                name: "Vegetables",
                icon: Leaf,
                href: "/farmers/category/vegetables",
                highlight: false,
              },
              {
                name: "Fruits",
                icon: Apple,
                href: "/farmers/category/fruits",
                highlight: false,
              },
              {
                name: "Dairy & Eggs",
                icon: Milk,
                href: "/farmers/category/dairy",
                highlight: false,
              },
              {
                name: "Meat & Fish",
                icon: Beef,
                href: "/farmers/category/meat",
                highlight: false,
              },
              {
                name: "Grains",
                icon: Wheat,
                href: "/farmers/category/grains",
                highlight: false,
              },
              {
                name: "Honey",
                icon: Droplets,
                href: "/farmers/category/honey",
                highlight: false,
              },
            ],
          },
          {
            title: "Livestock & Pets", // New section
            items: [
              {
                name: "Cattle",
                icon: Tractor,
                href: "/farmers/livestock?category=cattle",
                highlight: false,
              },
              {
                name: "Pets",
                icon: Cat,
                href: "/farmers/livestock?category=pets",
                highlight: false,
              },
              {
                name: "View All Livestock →",
                href: "/farmers/livestock",
                highlight: true,
              },
            ],
          },
            ...
            items: [
              {
                ...
                href: "/farmers/farmer/mama-lucy",
                highlight: false,
              },
              {
                name: "Kilonzo's Produce",
                href: "/farmers/farmer/kilonzo",
                highlight: false,
              },
              {
                name: "Mutua's Orchard",
                href: "/farmers/farmer/mutua",
                highlight: false,
              },
              {
      ...
      dropdown: {
        sections: [
          ...
          },
          {
            ...
            items: [
              {
                name: "Tala Town - Kwa Ndege",
                href: "/boda/pricing?from=Tala%20Town&to=Kwa%20Ndege",
                highlight: false,
              },
              {
                name: "Tala - Kangundo",
                href: "/boda/pricing?from=Tala%20Town&to=Kangundo",
                highlight: false,
              },
              {
                name: "Tala - Machakos",
                href: "/boda/pricing?from=Tala%20Town&to=Machakos",
                highlight: false,
              },
              {
        ...
        sections: [
          {
            ...
            items: [
              ...
              },
              {
                name: "Repairs",
                icon: Wrench,
                href: "/services/category/repairs",
                highlight: false,
              },
            ],
          },
            ...
            items: [
              {
                ...
                href: "/services/provider/john",
                highlight: false,
              },
              {
                name: "Mama Joy Salon",
                href: "/services/provider/mama-joy",
                highlight: false,
              },
              {
                name: "Tala Cyber",
                href: "/services/provider/tala-cyber",
                highlight: false,
              },
              {
        ...
        sections: [
            ...
            items: [
              {
                ...
                href: "/food/cuisine/local",
                highlight: false,
              },
              {
                name: "Fast Food",
                icon: Coffee,
                href: "/food/cuisine/fast-food",
                highlight: false,
              },
              {
                name: "Cafes",
                icon: Coffee,
                href: "/food/cuisine/cafes",
                highlight: false,
              },
              {
                name: "Hotels",
                icon: Hotel,
                href: "/food/cuisine/hotels",
                highlight: false,
              },
              {
                name: "Catering",
                icon: Package,
                href: "/food/cuisine/catering",
                highlight: false,
              },
            ],
          },
          {
            ...
            items: [
              {
                name: "Tala Kitchen",
                href: "/food/restaurant/tala-kitchen",
                highlight: false,
              },
              {
                name: "Kwa Ndege Eatery",
                href: "/food/restaurant/kwa-ndege",
                highlight: false,
              },
              {
                name: "Mama Pima Hotel",
                href: "/food/restaurant/mama-pima",
                highlight: false,
              },
        ...
        sections: [
            ...
            items: [
              {
                name: "Hotels",
                icon: Hotel,
                href: "/stays/category/hotels",
                highlight: false,
              },
              {
                name: "Airbnbs",
                icon: Home,
                href: "/stays/category/airbnbs",
                highlight: false,
              },
              {
                name: "Guest Houses",
                icon: Bed,
                href: "/stays/category/guest-houses",
                highlight: false,
              },
              {
                name: "Campsites",
                icon: Tent,
                href: "/stays/category/campsites",
                highlight: false,
              },
            ],
          },
          {
            ...
            items: [
              {
                name: "Tala Town",
                href: "/stays/location/tala-town",
                highlight: false,
              },
              {
                name: "Kangundo",
                href: "/stays/location/kangundo",
                highlight: false,
              },
              {
                name: "Machakos",
                href: "/stays/location/machakos",
                highlight: false,
              },
              {
                name: "Book Now →",
                href: "/stays/booking/new",
                highlight: true,
              },
            ],
          },
        ...
        items: [
          {
            ...
            href: "/sign-up",
            icon: UserPlus,
            description: "Join as a buyer, seller, or rider",
            highlight: true,
          },
        ],
      },
      ...
      >
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <span
              className={`text-xs font-medium px-2 py-1 rounded-full md:ml-2 ${
                scrolled
            ...
            {/* Desktop Navigation with Dropdowns - UPDATED WITH LINK COMPONENTS */}
                    ...
                    <div className="p-4">
                      {getStartedItems.sections.map((section, idx) => (
                        <div
                          key={idx}
                          className={
                            idx < getStartedItems.sections.length - 1
                              ? "mb-4 pb-4 border-b border-cool-gray/20"
                              : ""
                          }
                        >
                          <h4
        ...
        {/* Mobile Navigation - Accordion Style - UPDATED WITH LINK COMPONENTS */}
        {isOpen && (
          <div
            className={`md:hidden ${mobileMenuBg} border-t ${
              scrolled ? "border-cool-gray" : "border-white/20"
            } animate-fade-in max-h-[80vh] overflow-y-auto`}
          >
            <div className="px-4 py-4">
              ...
              {/* Mobile Get Started Section - UPDATED WITH LINK COMPONENTS */}
                ...
                <div className="space-y-2">
                  ...
                  <Link
                    ...
                    className={`flex items-center gap-3 p-3 rounded-xl transition-colors ${
                      scrolled
                        ? "text-slate-text hover:bg-redbull-blue/10"
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="space-y-3 text-slate-text">
                <p className="text-sm leading-relaxed">
                  <span className="font-semibold text-charcoal">E-TALA</span> is
                  Tala's first digital marketplace, connecting you to local
                  shops, farmers, boda riders, drivers, restaurants, and
